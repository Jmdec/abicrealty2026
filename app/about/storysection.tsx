      ...
      <div className="container mx-auto px-4 lg:px-4 space-y-12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-base text-default-500 dark:text-gray-300 leading-relaxed text-justify max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
              <Card className="w-full">
                <CardBody className="text-center p-6">
                  ...
                  <p className="text-default-500 text-base md:text-md leading-relaxed">
