...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://abicrealtyphdianne.com/media/abic-realty-loan-calculator-banner.png", // Replace with an actual relevant image
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://abicrealtyphdianne.com/media/abic-realty-loan-calculator-banner.png", // Ensure this is a valid image
    ],
  },
